        ...
        <>
            <div className="container">
                <div className="btn-wrap submenu">
                    <button onClick={handleShowNewReposForm}><FaFile />New</button>
                    <button onClick={updateRepos}><FaEdit />Update</button>
                    <button onClick={viewRepositoryDetail}><FaList />Repo Detail</button>
                    <button onClick={deleteRepos}><FaTrash />Delete</button>
                </div>
               <section className="register-wrap">
                    <div className="register">
                        ...
                        <div className="table-wrap">
                            <h2 className="table-title" >{user}' Samuel Repositories</h2>
